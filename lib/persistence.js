...
Persistence.prototype.compactDatafile = function () {
  ...
  if(this.db.beforeCompactDatafile){
    //Calling beforeCompactDatafile handler
    result = this.db.beforeCompactDatafile.call(this);
  }

  //only execute if beforeCompactDatafile handler returns a result
  if(result)
