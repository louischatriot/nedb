 ...
 */
function serialize (obj, algorithm, key) {
  var res;
  ...
  //encrypt
  if (algorithm.length > 0) { res = crypto.encrypt(res, algorithm, key); }
  return res;
}
 ...
 */
function deserialize (rawData, algorithm, key) {
  //decrypt
  if (algorithm.length > 0) { rawData = crypto.decrypt(rawData, algorithm, key); }
