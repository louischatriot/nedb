...
/**
 *  Casts the results of the query to a specified type.
 */
Cursor.prototype.cast = function(Constructor) {
    this._cast = Constructor;
    return this;
};
...
Cursor.prototype._exec = function(callback) {
  ...
  if (this._cast) {
      try {
          var Constructor = this._cast;
          res = res.map(function (candidate) {
              var object = new Constructor();

              // For every key in the target object, if the candidate has a corresponding key then assign it.
